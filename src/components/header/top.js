        ...
        <div className="row">
          {userLogged === null ?
            <div className="col-2 d-flex align-items-center justify-content-center">
              <Link to="/login" className="text mx-3 nav-link nav-custom">
              ...
              <Link to="/register" className="text mx-3 nav-link nav-custom">
          ...
          <div className="col-2 d-flex align-items-center justify-content-center" id="social-medias">
            <a href="/teste" className="text mx-3 mx-sm-2">
            ...
            <a href="/teste" className="text mx-3 mx-sm-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="#515151" class="bi bi-twitter-x" viewBox="0 0 16 16">
                <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z" />
              </svg>
            </a>
            <a href="/teste" className="text mx-3 mx-sm-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="#E1306C" class="bi bi-instagram" viewBox="0 0 16 16">
            ...
            <a href="/teste" className='text mx-3 mx-sm-2'>
              <svg id="whatsapp" xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="#25D366" class="bi bi-whatsapp" viewBox="0 0 16 16">
